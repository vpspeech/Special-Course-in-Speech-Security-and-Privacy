    ...
    def validation_for_B_dir(self):
        ...
        for file in os.listdir(validation_B_dir):
            ...
            wav_transformed = preprocess.world_speech_synthesis(f0=f0_converted,
                                                                ...
                                                                fs=sampling_rate,
                                                                frame_period=frame_period)
            isExist = os.path.exists(output_B_dir)
            if not isExist:
...
if __name__ == '__main__':
    ...
    output_A_dir_default = 'data/converted_sound/SF1'

    validation_B_dir_default = 'data/evaluation_all/TF2/'
    output_B_dir_default = 'data/converted_sound/TF2/'
